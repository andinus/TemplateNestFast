...
These options can be passed when creating the object.

- ~name-label~: Represents the label used for identifying the template
  name in the hash of template variables. Default value is ~TEMPLATE~.
