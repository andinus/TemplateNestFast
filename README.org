...
my $nest = Template::Nest::Fast.new(
  ...
  considered (look ~default-namespace-char~).

- ~default-namespace-char~ (default: ~.~): Say you want to namespace
...
%(
  ...
  Note: To disable this behaviour set ~default-namespace-char~ to an
  empty string.
